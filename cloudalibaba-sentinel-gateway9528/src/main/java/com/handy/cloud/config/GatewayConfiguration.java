...
public class GatewayConfiguration {
    ...
    private void initBlockHandler() {
        ...
        rules.add(new GatewayFlowRule("pay_routh1").setCount(2).setIntervalSec(1));  //1秒最多点击2次
        ...
        BlockRequestHandler requestHandler = new BlockRequestHandler() {
            ...
            public Mono<ServerResponse> handleRequest(ServerWebExchange exchange, Throwable throwable) {
                ...
                map.put("errorCode", HttpStatus.TOO_MANY_REQUESTS.getReasonPhrase()); //提示太多请求的
